...
void main(void)
{
    ...
    while(1)
    {
        ...
        if(bandera_UART>1)
        {
            enviar_string(txt_pot);
            enviar_string(pot_string);

            enviar_string(txt_cont);
            enviar_string(cont_string);

            enviar_string(txt_temp);
            enviar_string(temp_string);
            enviar_char(13);
